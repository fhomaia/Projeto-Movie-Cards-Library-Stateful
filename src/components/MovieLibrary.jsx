...
class MovieLibrary extends React.Component {
  ...
  moviesByGender(movies, bookmarkedOnly, selectedGenre) {
    ...
    return this.moviesMarked(movies, bookmarkedOnly).filter((movie) => 
  ...
  filteredMovies(movies, bookmarkedOnly, selectedGenre, searchText) {
    ...
    .filter((movie) => {return (movie.title.includes(searchText)
  ...
  render() {
    ...
    return (
      ...
      />
      <MovieList
      movies={this.filteredMovies(movies, bookmarkedOnly, selectedGenre, searchText)}
      />
